...
$result = $conn->query("SELECT * FROM information WHERE section = 'BSIT - 2B'");
?>
...
<head>
    ...
    <link rel="shortcut icon" href="section_icon/B.png" type="image/x-icon">
    <title>BSIT - 2B</title>
</head>
<body>
    ...
    <h1 class="title">ALL STUDENTS BSIT - 2B</h1>
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        |
                        <a class="setting" id="del" href="delete_b.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this student?')">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
