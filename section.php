...
<body>
    ...
    <div class="section_info">
        <div class="box1">
            ...
            <p class="pp">Total Students = <span class="total_number"><?= htmlspecialchars($total_2a) ?></span></p>
        </div>
        <br>

        <div class="student_sec">
            <button class="all_student_sec" onclick="window.location.href='2A.php'">All Students</button>
            <button class="all_student_sec2" onclick="window.location.href='2B.php'">All Students</button>
            <button class="all_student_sec3" onclick="window.location.href='2C.php'">All Students</button>
        </div>

        <div class="box2">
            <h2 class="h22">BSIT - 2B</h2>
            <p class="pp">Total Students = <span class="total_number"><?= htmlspecialchars($total_2b) ?></span></p>
        </div>
        <br>

        <div class="box3">
            <h2 class="h22">BSIT - 2C</h2>
            <p class="pp">Total Students = <span class="total_number"><?= htmlspecialchars($total_2c) ?></span></p>
        </div>
    </div>
