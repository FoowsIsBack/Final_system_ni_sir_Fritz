...
<head>
    ...
    <link rel="shortcut icon" href="section_icon/C.png" type="image/x-icon">
    <title>BSIT - 2C</title>
</head>
<body>
    ...
    <h1 class="title">ALL STUDENTS BSIT - 2C</h1>
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        |
                        <a class="setting" id="del" href="delete_c.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this student?')">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
